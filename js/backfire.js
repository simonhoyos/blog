...
(function() {
  ...
  Backbone.Firebase = function(ref) {
    ...
    this._fbref.on("child_added", this._childAdded, this._error, this);
    this._fbref.on("child_moved", this._childMoved, this._error, this);
    this._fbref.on("child_changed", this._childChanged, this._error, this);
    this._fbref.on("child_removed", this._childRemoved, this._error, this);
  };
  ...
  Backbone.Firebase.Collection = Backbone.Collection.extend({
    ...
    constructor: function(models, options) {
      ...
      this.firebase.on("child_added", _.bind(this._childAdded, this), _.bind(this._error, this));
    ...
    _error: function(errorObject) {
      this.trigger("error", this, errorObject);
    },
  });
